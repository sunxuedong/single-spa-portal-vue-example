...
This example is based on [simple-single-spa-webpack-example](https://github.com/me-12/single-spa-portal-example)

## How to run this project
1. Clone this project
2. Jump into workflow folder and do:
   - `npm install`
   - `npm run watch:portal`
3. Then start the portal with:
   - `npm install`
   - `npm run watch`
4. Open up http://localhost:7000 in a web browser.
